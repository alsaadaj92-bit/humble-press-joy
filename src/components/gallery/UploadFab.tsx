...
export function UploadFab() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 right-4 z-40 flex flex-col items-end gap-2 md:bottom-6 md:right-6" style={{ marginBottom: "calc(env(safe-area-inset-bottom) + 4px)" }}>
        {menuOpen && (
          <>
            {isNative() && (
              <>
